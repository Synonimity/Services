"""
Templates live in app/templates/<name>/{subject.txt, body.html}, all
extending the shared _layout.html. Add a new email type by adding a new
...
def _html_to_text(html: str) -> str:
    """Very small best-effort HTML -> plaintext fallback for the text/plain part."""
...
def render_email(template_name: str, variables: dict) -> tuple[str, str, str]:
